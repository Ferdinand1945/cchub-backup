<head><title>CCHub | Panel</title>
  ...
  <link type="text/css" rel="stylesheet" href="undefined">
  ...
  <!--Loading style-->
  <link type="text/css" rel="stylesheet" href="css/themes/style2/yellow-green.css" id="" class="style-change color-change">
    ...
    <div id="header-topbar-option-demo" class="page-header-topbar">
      <nav id="topbar" role="navigation" style="margin-bottom: 0;" data-step="3" data-intro="&lt;b&gt;Topbar&lt;/b&gt; has other styles with live demo. Go to &lt;b&gt;Layouts-&gt;Header&amp;Topbar&lt;/b&gt; and check it out." class="navbar navbar-default navbar-static-top">
        <div class="navbar-header">
          ...
          <a id="logo" href="index.php" class="navbar-brand"><span class="fa fa-rocket"></span><span class="logo-text">µAdmin</span><span style="display: none" class="logo-text-icon">µ</span></a></div>
        <div class="topbar-main"><a id="menu-toggle" href="#" class="hidden-xs"><i class="fa fa-bars"></i></a>
          ...
          <ul class="nav navbar navbar-top-links navbar-right mbn">
            ...
            <li class="dropdown topbar-user"><a data-hover="dropdown" href="#" class="dropdown-toggle"><img src="https://s3.amazonaws.com/uifaces/faces/twitter/kolage/48.jpg" alt="" class="img-responsive img-circle"/>&nbsp;<span class="hidden-xs"><?php echo $_SESSION['user']; ?></span>&nbsp;<span class="caret"></span></a>
              <ul class="dropdown-menu dropdown-user pull-right">
                <li><a href="panel.php"><i class="fa fa-user"></i>My Profile</a></li>
...
<div class="icon-bg bg-orange"></div>
            ...
            <li><a href=""><i class="fa fa-edit fa-fw">
              ...
              </i><span class="menu-title">Kreditcheck</span><span class="fa arrow"></span></a>

              <ul class="nav nav-first-level collapse out">
                <li class="dropdown"><a href="creditcheck.php"><i class="fa fa-bar-chart-o fa-fw">
                  <div class="icon-bg bg-orange"></div>
                  </i><span class="menu-title">Gör en upplysning</span><span class="fa arrow"></span></a>
                </li>

                <li class=""><a href="list.php"><i class="fa fa-database fa-fw">
                  <div class="icon-bg bg-red"></div>
                  </i><span class="menu-title">Logg</span><span class="fa arrow"></span>
                  </a>
                </li>
                <li class=""><a href="doawnload-data.php"><i class="fa fa-bar-chart-o fa-fw">
                  <div class="icon-bg bg-orange"></div>
                  </i><span class="menu-title">Hämta data</span><span class="fa arrow"></span></a>
                </li>
                <li class=""><a href="settings.php"><i class="fa fa-slack fa-fw">
                  <div class="icon-bg bg-green"></div>
                  </i><span class="menu-title">Inställningar</span></a>
                </li>
